...
#define assert(expr1,expr2) {auto __1 = expr1;auto __2 = expr2;if(__1 == __2 ){std::cout<<"assert: "<<#expr1<<" equals " <<__2<<" passed"<<std::endl;}else{std::cout<<"assert failed: expected: "<<__2<<" but got: "<<__1<<std::endl; return 1;}}
